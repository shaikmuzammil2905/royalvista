...
export const defaultPortfolio: PortfolioItem[] = [
  {
    id: "port-1",
    title: "The Golden Hour Wedding Film",
    category: "Weddings",
    mediaType: "video",
  ...
  {
    id: "port-2",
    title: "Eco Luxury Resort Showcase",
    ...
    description: "Cinematic commercial detailing the architecture, wellness facilities, and surrounding nature of a luxury eco-retreat.",
    client: "Elysium Resorts",
    year: "2025"
  },
  {
    id: "port-3",
    title: "Urban Tech Smartwatch Promo",
    ...
    description: "Sleek studio product photography with gold details highlighting the craftsmanship and interface of a luxury smartwatch.",
    client: "Aura Tech",
    year: "2024"
  },
  {
    id: "port-4",
    title: "Chasing Horizons - Travel Doc",
    category: "Documentaries",
    mediaType: "video",
    mediaUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
    thumbnailUrl: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&q=80&w=800",
    description: "An intimate look into remote nomadic cultures, their traditions, and the majestic landscapes they call home.",
    client: "Heritage Channel",
    year: "2024"
  },
  {
    id: "port-5",
    title: "Elevated Minds Podcast Highlight",
    category: "Podcasts",
    mediaType: "video",
    mediaUrl: "https://www.w3schools.com/html/movie.mp4",
    thumbnailUrl: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&q=80&w=800",
    description: "Multi-camera audio switched dialogue showcase clip emphasizing clarity, clean graphics, and pacing.",
    client: "Dr. Alistair Vance",
    year: "2025"
  },
  {
    id: "port-6",
    title: "Street Fashion Summer Campaign",
    category: "Reels",
    mediaType: "image",
    mediaUrl: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80&w=1200",
    thumbnailUrl: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80&w=800",
    description: "Highly engaging, fast-paced street video campaign edited specifically for mobile vertical social platforms.",
    client: "Kora Boutique",
    year: "2025"
  },
  {
    id: "port-7",
    title: "Techno-Futurism YouTube Vlog",
    category: "YouTube",
    mediaType: "video",
    mediaUrl: "https://www.w3schools.com/html/mov_bbb.mp4",
    thumbnailUrl: "https://images.unsplash.com/photo-1548345680-f5475ea5df84?auto=format&fit=crop&q=80&w=800",
    description: "High-retention editing style with graphic overlays, sound FX, and speed ramps for a top tech channel.",
    client: "TechPulse",
    year: "2025"
  },
  {
    ...
    category: "Corporate",
    mediaType: "image",
    mediaUrl: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&q=80&w=1200",
    thumbnailUrl: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&q=80&w=800",
    description: "Premium corporate keynote visual report, detailing panel discussions and dynamic b-roll for corporate branding.",
